...
//#include <THC/THC.h>  // 필요 여부에 따라 제거 가능
#include "interpolation_cuda_kernel.h"

//extern THCState *state;  // 필요하지 않다면 제거

void nearestneighbor_cuda(int b, int n, int m, 
                          at::Tensor unknown_tensor, at::Tensor known_tensor, 
                          at::Tensor dist2_tensor, at::Tensor idx_tensor)
{
...
void interpolation_backward_cuda(int b, int c, int n, int m, 
                                 ...
                                 at::Tensor weight_tensor, at::Tensor grad_points_tensor)
{
...
void nearestneighbor_cuda_fast(int b, int n, int m, 
                               at::Tensor unknown_tensor, at::Tensor known_tensor, 
                               at::Tensor dist2_tensor, at::Tensor idx_tensor) 
{
    const float *unknown = unknown_tensor.data_ptr<float>();
