...
end_epoch = 350  # Total number of training epochs (tunable)
...
model_cfg = dict(
    backbone_cfg=dict(
        ...
        order=("z", "z-trans", "hilbert", "hilbert-trans"),   # Serialization orders # order=("z", "z-trans", "hilbert", "hilbert-trans", "hz", "hz-trans")
        stride=(2,2,2,2),
        ...
        cross_attn=False,                       # Enable cross-attention fusion in decoder
    ...
    pool_cfg=dict(
        type='SPoC',           # Pooling type: NetVlad/MAC/GeM
        in_channels=512,          
